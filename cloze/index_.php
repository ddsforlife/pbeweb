            ...
            for (let i = 0; i < targetBlanks; i++) {
                ...
                if (sectionWords.length > 0) {
                    if (state.settings.randomBlanks) {
                        // Random mode: pick a random word from this section
                        const randomIdx = Math.floor(Math.random() * sectionWords.length);
                        selectedWords.push(sectionWords[randomIdx]);
                    } else {
                        // Default: pick the highest-scoring word from this section
                    ...
                    if (fallbackWords.length > 0) {
                        if (state.settings.randomBlanks) {
                            const randomIdx = Math.floor(Math.random() * fallbackWords.length);
                            selectedWords.push(fallbackWords[randomIdx]);
                        } else {
