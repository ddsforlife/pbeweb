<?php
// ─── Cache-bust: force fresh copy on every new deploy ───────────────────────
$fileVersion = md5_file(__FILE__); // Changes automatically whenever you save

header('Cache-Control: no-cache, must-revalidate');
header('ETag: "' . $fileVersion . '"');

// Conditional GET — serve 304 if browser already has the latest
if (
...
<head>
    ...
    <title>Cloze - PBE Team Bold</title>
    ...
    <?php 
    $version = substr(md5_file(__FILE__), 0, 8); // e.g. 'a3f92b1c'
    ...
    <style>
        ...
        * {
        ...
        /* Invisible word that sizes the blank to exactly the answer's rendered width */
        .blank-sizer {
            visibility: hidden;
            display: inline-block;
            padding: 0 9px;
        ...
        /* Text Size Options */
        [data-text-size="xs"] .passage-text { font-size: 1.1rem; }
        [data-text-size="xs"] .blank { font-size: 1.0rem; }
        [data-text-size="xs"] .blank-input { font-size: 1.0rem; }
        [data-text-size="xs"] .verse-number { font-size: 0.85rem; }

        [data-text-size="sm"] .passage-text { font-size: 1.3rem; }
        [data-text-size="sm"] .blank { font-size: 1.2rem; }
        [data-text-size="sm"] .blank-input { font-size: 1.2rem; }
        [data-text-size="sm"] .verse-number { font-size: 1.0rem; }

        /* md = default, uses base CSS values */

        [data-text-size="lg"] .passage-text { font-size: 1.8rem; }
        [data-text-size="lg"] .blank { font-size: 1.7rem; }
        [data-text-size="lg"] .blank-input { font-size: 1.7rem; }
        [data-text-size="lg"] .verse-number { font-size: 1.4rem; }

        [data-text-size="xl"] .passage-text { font-size: 2.1rem; }
        [data-text-size="xl"] .blank { font-size: 2.0rem; }
        [data-text-size="xl"] .blank-input { font-size: 2.0rem; }
        [data-text-size="xl"] .verse-number { font-size: 1.65rem; }

        /* Mobile superscript verse numbers scale down for text sizes */
        @media (max-width: 768px) {
            [data-text-size="xs"] .verse-number { font-size: 0.65rem; }
            [data-text-size="sm"] .verse-number { font-size: 0.75rem; }
            [data-text-size="lg"] .verse-number { font-size: 1.1rem; }
            [data-text-size="xl"] .verse-number { font-size: 1.3rem; }
        }
        ...
        /* Push theme toggle + menu to the right as a group */
        ...
        @media (max-width: 768px) {
            .progress-bar-container.sticky-top {
                top: 46px; /* Match mobile toolbar height */
            }
            
            .progress-bar-container.sticky-bottom {
                bottom: 46px; /* Match mobile toolbar height */
            }
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Ensure theme toggle matches other buttons vertically */
            .theme-toggle-toolbar {
        ...
        @media print {
            ...
            /* Print BLANK: hide any completed/typed content so blank stays empty */
            .blank:not(.print-filled) .blank-input {
                visibility: hidden !important;
            }
            ...
            .blank.print-filled .blank-input {
                display: flex !important;
                visibility: visible !important;
                color: black !important;
            }
            
            .blank.print-filled .blank-sizer {
                visibility: hidden !important;
            }
        }
    </style>
        ...
        <header class="header">
            <div class="logo-section">
                ...
                <div class="title-section">
                    <h1>Cloze Study</h1>
                    <p>Fill-in-the-blank practice</p>
                </div>
            </div>
        ...
        <div id="studyScreen">
            <div class="study-container">
                ...
                <div class="study-toolbar" id="studyToolbar">
                    ...
                    <button class="toolbar-btn theme-toggle-toolbar" id="themeToggleTop" title="Toggle Light/Dark">☀️</button>
                ...
                <div class="sticky-bottom-controls" id="stickyBottomControls" style="display: none;">
                    ...
                    <button class="toolbar-btn theme-toggle-toolbar" id="themeToggleBottom" title="Toggle Light/Dark">☀️</button>
            ...
            <div class="modal-content modal-unified">
                ...
                <div class="modal-tab-content" id="settingsTab">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            <div>
                                <div class="setting-label">Randomize Blanks</div>
                                <div class="setting-description">Shuffle which words are blanked each session for variety</div>
                            </div>
                            <div class="toggle" id="randomBlanksToggle">
                                <div class="toggle-slider"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="text-size-row" id="textSizeRow">
                            <button class="text-size-btn" data-size="xs" style="font-size: 0.7rem;">A</button>
                            <button class="text-size-btn" data-size="sm" style="font-size: 0.85rem;">A</button>
                            <button class="text-size-btn active" data-size="md" style="font-size: 1.0rem;">A</button>
                            <button class="text-size-btn" data-size="lg" style="font-size: 1.2rem;">A</button>
                            <button class="text-size-btn" data-size="xl" style="font-size: 1.4rem;">A</button>
                        </div>
                    </div>
                ...
                <!-- About Tab -->
                <div class="modal-tab-content" id="aboutTab">
                    <div class="settings-section">
                        <div class="settings-section-title">ℹ️ About</div>
                        
                        <div class="setting-item">
                            <div>
                                <div class="setting-label">PBE Cloze Study</div>
                                <div class="setting-description">Version <?php echo $version; ?></div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 1rem; padding: 1.5rem; background: var(--bg-secondary); border: 2px solid var(--border); border-radius: 12px;">
                            <h4 style="margin-bottom: 1rem; color: var(--text-primary); font-weight: 700;">Credits & Acknowledgments</h4>
                        ...
                        <div style="margin-top: 1rem; padding: 1.5rem; background: var(--bg-secondary); border: 2px solid var(--border); border-radius: 12px; text-align: center;">
    ...
    <script>
        ...
        const state = {
            ...
            settings: {
                ...
                randomBlanks: true, // Randomize which words are blanked each session
        ...
        // Blank widths are now determined by the .blank-sizer CSS pattern (no config needed)
        ...
        // Theme
        function initTheme() {
            // Shared 'theme' key takes priority; fall back to legacy key
            const savedTheme = localStorage.getItem('theme') || localStorage.getItem('bibleClozeTheme') || 'light';
        ...
        function applyTheme(theme) {
            ...
            localStorage.setItem('bibleClozeTheme', theme); // legacy key
            updateThemeToggleIcon(theme);
        }

        function toggleTheme() {
            const current = localStorage.getItem('theme') || localStorage.getItem('bibleClozeTheme') || 'light';
        ...
        function updateThemeToggleIcon(theme) {
            ...
            document.querySelectorAll('.theme-toggle-toolbar').forEach(btn => btn.textContent = icon);
        }
        ...
        function applySettings() {
            ...
            document.getElementById('randomBlanksToggle').classList.toggle('active', state.settings.randomBlanks);

            // Apply text size
            const size = state.settings.textSize || 'md';
            DOM.studyScreen.dataset.textSize = size;
        ...
        function applyControlStyle() {
            ...
            if (style === 'floating') {
                ...
                if (DOM.studyContainer) {
                    DOM.studyContainer.style.paddingTop = '0';
                    DOM.studyContainer.style.paddingBottom = '0';
                }
                ...
                if (DOM.studyContainer) {
                    DOM.studyContainer.style.paddingTop = '80px';
                    DOM.studyContainer.style.paddingBottom = '0';
                }
                ...
                if (DOM.studyContainer) {
                    DOM.studyContainer.style.paddingTop = '0';
                    DOM.studyContainer.style.paddingBottom = '90px'; // Space for fixed bottom bar + progress
                }
        ...
        function createBlanks(text) {
            ...
            const isImpossible = state.settings.difficulty === 100;
            ...
            state.currentVerses.forEach(verse => {
                ...
                const scoredWords = words.map((word, localIndex) => {
                    ...
                    // At <100% difficulty, hard-exclude trivial words entirely
                    if (!isImpossible) {
                        if (cleanWord.length <= 2) {
                            return { word, localIndex, globalIndex: globalWordIndex + localIndex, score: -1000 };
                        }
                        if (ARTICLES_PREPOSITIONS.has(cleanWord)) {
                            return { word, localIndex, globalIndex: globalWordIndex + localIndex, score: -1000 };
                        }
                    } else {
                        // Impossible: still skip empty/punctuation-only tokens
                        if (cleanWord.length === 0) {
                            return { word, localIndex, globalIndex: globalWordIndex + localIndex, score: -1000 };
                        }
                    }
                    
                    // Quality scoring — higher = more likely to be blanked
                    let score = 0;
                    if (THEOLOGICAL_WORDS.has(cleanWord)) score += 100; // Theological terms
                    score += cleanWord.length * 3;                       // Strongly favour longer words
                    if (word[0] === word[0].toUpperCase() && word[0] !== word[0].toLowerCase()) score += 30; // Proper nouns
                    if (/[qxz]/i.test(cleanWord)) score += 20;           // Uncommon letters
                    // At impossible, mildly de-prioritise trivial words so better ones still come first
                    if (isImpossible && ARTICLES_PREPOSITIONS.has(cleanWord)) score -= 20;
                ...
                // Pick words evenly distributed across verse, prioritising by score
        ...
        // - Sections are based on actual verse word positions, not validWords count,
        //   so blanks spread across the full verse even when many words are filtered out
        // - Adjacency guard: never picks a word directly next to an already-selected word
        // - Random mode: score-weighted (longer/theological words more likely, not equal-chance)
        // - Non-random mode: always picks highest-scoring word per section
        function selectWordsEvenly(validWords, targetBlanks) {
            if (validWords.length === 0) return [];
            if (targetBlanks >= validWords.length) return validWords;

            // Use actual verse span for section boundaries so distribution
            // reflects real word positions, not the filtered-down valid word count
            const minPos = Math.min(...validWords.map(w => w.localIndex));
            const maxPos = Math.max(...validWords.map(w => w.localIndex));
            const span = maxPos - minPos + 1;
            const sectionSize = span / targetBlanks;

            const selectedWords = [];

            const isAdjacent = (w) => selectedWords.some(s => Math.abs(s.localIndex - w.localIndex) <= 1);
            const notSelected  = (w) => !selectedWords.includes(w);

            const pickFrom = (candidates) => {
                if (state.settings.randomBlanks) {
                    const minScore = Math.min(...candidates.map(w => w.score));
                    const weights  = candidates.map(w => w.score - minScore + 1);
                    const total    = weights.reduce((a, b) => a + b, 0);
                    let rand = Math.random() * total;
                    for (let j = 0; j < candidates.length; j++) {
                        rand -= weights[j];
                        if (rand <= 0) return candidates[j];
                    }
                    return candidates[candidates.length - 1];
                } else {
                    return candidates.reduce((best, w) => w.score > best.score ? w : best);
                }
            };

            for (let i = 0; i < targetBlanks; i++) {
                const sectionStart = minPos + Math.floor(i * sectionSize);
                const sectionEnd   = minPos + Math.floor((i + 1) * sectionSize);

                const inSection = (w) => w.localIndex >= sectionStart && w.localIndex < sectionEnd;

                // Priority 1: in-section, non-adjacent
                let pool = validWords.filter(w => inSection(w) && notSelected(w) && !isAdjacent(w));

                // Priority 2: in-section, ignoring adjacency (section is too dense to avoid it)
                if (pool.length === 0)
                    pool = validWords.filter(w => inSection(w) && notSelected(w));

                // Priority 3: anywhere in verse, non-adjacent (section had nothing)
                if (pool.length === 0)
                    pool = validWords.filter(w => notSelected(w) && !isAdjacent(w));

                // Priority 4: last resort — any unselected word
                if (pool.length === 0)
                    pool = validWords.filter(notSelected);

                if (pool.length === 0) continue;

                selectedWords.push(pickFrom(pool));
            }
            ...
            state.currentVerses.forEach((verse, verseIdx) => {
                ...
                words.forEach((word, wordIdx) => {
                    if (blankIndices.has(globalWordIndex)) {
                        ...
                        // Sizer span (invisible) sizes the blank to exactly the answer word's rendered width.
                        // blank-input overlays it absolutely. Wrap in nowrap so trailing punct never orphans.
                        html += `<span style="white-space:nowrap;display:inline">${blank.leadingPunct}<span class="${classes}" data-blank-index="${blankIndex}" onclick="handleBlankClick(event,${blankIndex})" ontouchend="handleBlankTouch(event,${blankIndex})"><span class="blank-sizer" aria-hidden="true">${blank.word}</span><span class="blank-input">${displayText}</span></span>${blank.trailingPunct}</span> `;
                    } else {
        ...
        function checkAnswer() {
            ...
            if (input.length >= target.length) {
                if (input === target) {
                    ...
                    // Only finish when every blank is truly completed
                    if (state.blanks.every(b => b.completed)) {
                        finishChapter();
                    } else {
                        // Find next incomplete blank, wrap around if needed
                        let nextIndex = state.currentBlankIndex + 1;
                        while (nextIndex < state.blanks.length && state.blanks[nextIndex].completed) nextIndex++;
                        if (nextIndex >= state.blanks.length) {
                            nextIndex = 0;
                            while (nextIndex < state.currentBlankIndex && state.blanks[nextIndex].completed) nextIndex++;
                        }
            ...
            state.currentVerses.forEach((verse, verseIdx) => {
                ...
                words.forEach((word, wordIdx) => {
                    if (blankIndices.has(globalWordIndex)) {
                        ...
                        // Sizer pattern — same as live rendering, no fixed widths
                        printHTML += blank.leadingPunct;
                        printHTML += `<span class="blank print-filled"><span class="blank-sizer" aria-hidden="true">${blank.word}</span><span class="blank-input">${blank.word}</span></span>`;
        ...
        setupToggle('randomBlanksToggle', 'randomBlanks');

        // Text Size buttons
        document.querySelectorAll('.text-size-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                state.settings.textSize = this.dataset.size;
                saveSettings();
                applySettings();
                // Re-render passage with new blank widths if studying
        ...
        // Theme Toggle (toolbar buttons)
        document.querySelectorAll('.theme-toggle-toolbar').forEach(btn => {
